  ...
  >
    <div class="mx-auto max-w-3xl text-center">
      ...
      <div class="mt-8 flex flex-wrap justify-center gap-4">
        <HashLink
          class="block w-full invisible sm:visible rounded border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-transparent hover:text-white focus:outline-none focus:ring active:text-opacity-75 sm:w-auto"
          smooth to="/#contact"
        >
          Contact
        </HashLink>
        ...
        <HashLink
          class="block w-full invisible sm:visible rounded border border-blue-600 px-12 py-3 text-sm font-medium text-white hover:bg-blue-600 focus:outline-none focus:ring active:bg-blue-500 sm:w-auto"
          href="/about"
          smooth to="/#1"
        >
          Learn More
